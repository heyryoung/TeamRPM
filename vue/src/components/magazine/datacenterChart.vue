        ...
        <div id="Export"  class="tabcontent" >
            <table id='ExportTable'>
                ...
                <tr v-for=" ( e , index ) of Export" :key="e.Total">
                    <td class="subCate" :colspan="EcolspanNum( e.subCategory )" :rowspan=" ErowspanNum( e.subCategory )" v-if="ErowspanSetting( e.subCategory , index )" >{{ e.subCategory }}</td>
...
<style scoped>
    ...
    .filetitle {text-align: left; padding-left: 30px; width: 40%; line-height:30px; font-size: 15px; }
    .fileBox {width: 50%; float: right}
    .fileBox .fileName {display:inline-block;width:400px;height:30px;padding-left:10px;margin-right:5px;line-height:30px;border:1px solid #aaa;background-color:#fff;vertical-align:middle; font-family: 'Helvetica', Arial;}
    .fileBox .btn_file {display:inline-block;border:1px solid #000;width:100px;height:30px;font-size:0.8em;line-height:30px;text-align:center;vertical-align:middle;margin-right: 0px}
    .fileBox input[type="file"] {position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);bord:0}
</style>